...
const AuthScreen = () => {
  ...
  return (
    <>
      ...
      <div className="py-10 bg-black text-white">
        <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2">
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-lg md:text-xl">
              Stream unlimited movies, TV shows on your phone, tablet, laptop
              and TV.
            </p>
          </div>
      ...
      {/* fourth section */}
      <div className="py-10 bg-black text-white">
        <div className="max-w-6xl mx-auto flex items-center justify-center md:flex-row flex-col-reverse">
          <div className="flex-1 relative">
            <img src="/kids.png" alt="kids image" />
          </div>
          <div className="flex-1 text-center md:text-left">
            <h2 className="text-4xl md:text-5xl font-extra bold mb-4">
