  ...
  return (
    <>
      <div className="relative h-screen text-white">
        ...
        {imageLoading && (
          <div className="top-0 left-0 h-full w-full absolute flex items-center justify-center bg-black/70 shimmer -z-10" />
        )}
        <img
          src={ORIGINAL_BASE_URL + trendingContent?.backdrop_path}
          alt="Hero Image"
          className="w-full h-full absolute top-0 left-0 -z-50 object-cover"
          onLoad={() => {
            setImageLoading(false);
          }}
        />
        <div
          className="w-full h-full absolute top-0 left-0 -z-50 bg-black/50"
          aria-hidden="true"
        />
